...
import { Search, Building2, Eye, Users, Banknote, PackageOpen, Building } from 'lucide-react';
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  <div className="bg-slate-800 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-xs text-slate-400">Ind. Custo</p>
                    </div>
                    <p className="text-xl font-bold text-orange-400">{construtora.totalCustosIndiretos}</p>
                  </div>
                </div>
              </div>
