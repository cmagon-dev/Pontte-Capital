...
import { Eye, EyeOff, Loader2, Building2, Landmark, HardHat } from 'lucide-react';
...
export default function EditarUsuarioForm({
  ...
  const [form, setForm] = useState({
    ...
    fundoIds: new Set<string>(usuario.fundoIds),
    construtoraIds: new Set<string>(usuario.construtoraIds),
    fiadorConstrutoraIds: new Set<string>(usuario.fiadorConstrutoraIds),
    fiadorObraIds: new Set<string>(usuario.fiadorObraIds),
  });
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid grid-cols-1 gap-5">
        ...
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1.5">
            Nova Senha
            <span className="text-slate-500 font-normal ml-1">(deixe em branco para manter)</span>
          </label>
