...
import { criarDocumentoFiador } from '@/app/actions/documentos';

export default function UploadDocumentoFiadorPage({ params }: { params: { id: string } }) {
  ...
  // Tipos de documentos financeiros para fiadores
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append('fiadorId', params.id);
      formDataToSend.append('categoria', 'Financeiro'); // Categoria padrão para documentos de fiador
      ...
      const result = await criarDocumentoFiador(formDataToSend);
      ...
      // Sucesso - redirecionar para página de documentos
      router.push(`/cadastros/fiadores/${params.id}/documentos`);
      router.refresh();
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400">Comprovação de Patrimônio e Renda</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-6">
          ...
          <div className="flex justify-end gap-4">
            ...
            <button
              type="submit"
              disabled={!file || !formData.tipo || isSubmitting}
