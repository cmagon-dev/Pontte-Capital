...
export default function DocumentosList({ documentos, fundoId }: DocumentosListProps) {
  ...
  const handleDelete = async (id: string) => {
    ...
    setDeletingId(id);
    try {
      const result = await excluirDocumento(id, fundoId, 'fundo');
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-lg p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold text-white">Documentos do Fundo</h2>
        <Link
          href={`/cadastros/fundos/${fundoId}/documentos/upload`}
